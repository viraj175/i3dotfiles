...
globalkeys = gears.table.join(
    ...
    -- Shortcuts and some important functionalities

    -- print screen
    awful.key({ "Shift" },            "Print",     function ()  
    awful.util.spawn("flameshot gui") end,
            {description = "select screenshot", group = "viraj"}),
    ...
    awful.util.spawn("flameshot screen") end,
              {description = "print whole screen", group = "viraj"}),

    -- Rofi
    awful.key({ modkey },            "space",     function ()  
    awful.util.spawn("rofi -show run") end,
              {description = "launch rofi", group = "viraj"}),

    -- Firefox
    awful.key({ modkey },            "b",     function ()  
    awful.util.spawn("firefox") end,
              {description = "launch chrome", group = "viraj"}),

    -- Launch pcmanfm
    awful.key({ modkey },            "t",     function ()  
    awful.util.spawn("pcmanfm") end,
              {description = "launch file-browser", group = "viraj"}),

    -- Launch ranger
    awful.key({ modkey }, "p", function() 
    awful.util.spawn("ranger") end,
              {description = "open ranger", group = "viraj"})
)
...
awful.rules.rules = {
    ...
    -- kitty borders
    -- { rule = { class = "kitty" },
    -- properties = { border_width = 4 , border_color = "#ff0000"}
    -- },

    { rule = { class = "kitty" },
    properties = { border_width = 4 },
    callback = function(c)
        c.border_color = "#FF0000" -- Set border color to red
    end
    },
